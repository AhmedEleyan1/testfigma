    ...
    <div className="relative shrink-0 size-[20px]" data-name="arrows / caret down">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="arrow_drop_down">
          <mask height="20" id="mask0_127_3650" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_127_3650)">
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="contact / phone">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="contact / phone">
          <mask height="16" id="mask0_127_3780" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_127_3780)">
...
function ContactMail() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="contact / mail">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="contact / mail">
          <mask height="16" id="mask0_127_3759" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_127_3759)">
    ...
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%-0.37px)] size-[20px] top-[calc(50%-0.19px)]" data-name="chevron_backward">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="chevron_backward">
          <mask height="20" id="mask0_127_3695" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_127_3695)">
...
function ChevronRight() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[20px] top-1/2" data-name="chevron_right">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="chevron_right">
          <mask height="20" id="mask0_127_3746" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_127_3746)">
    ...
    <div className="relative shrink-0 size-[20px]" data-name="hotel / accommodation">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="hotel / accommodation">
          <mask height="20" id="mask0_127_3714" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_127_3714)">
...
function BookingSource() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="booking_source">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="booking_source">
          <mask height="16" id="mask0_127_3771" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_127_3771)">
...
function MainPin() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="main / pin">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="main / pin">
          <mask height="20" id="mask0_127_3727" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_127_3727)">
...
function HotelDining() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="hotel / dining">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="hotel / dining">
          <mask height="20" id="mask0_127_3718" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_127_3718)">
...
function TimeTime() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="time / time">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="time / time">
          <mask height="16" id="mask0_127_3706" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_127_3706)">
    ...
    <div className="relative shrink-0 size-[16px]" data-name="people / group outline">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="people / group outline">
          <mask height="16" id="mask0_127_3691" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_127_3691)">
    ...
    <div className="relative shrink-0 size-[16px]" data-name="location / pin outlined">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="location / pin outlined">
          <mask height="16" id="mask0_127_3753" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
...
function MainNote() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="main / note">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="main / note">
          <mask height="16" id="mask0_127_3646" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_127_3646)">
    ...
    <div className="relative shrink-0 size-[16px]" data-name="main / new window">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="main / new window">
          <mask height="16" id="mask0_127_3634" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_127_3634)">
...
function HotelSpa() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="hotel / spa">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="hotel / spa">
          <mask height="20" id="mask0_127_3682" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_127_3682)">
...
function PeopleProfile() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="people / profile">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="people / profile">
          <mask height="16" id="mask0_127_3678" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_127_3678)">
    ...
    <div className="relative shrink-0 size-[16px]" data-name="people / practitioner">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="people / practitioner">
          <mask height="16" id="mask0_127_3654" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_127_3654)">
...
function PeopleGroup() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="people / group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="people / group">
          <mask height="20" id="mask0_127_3702" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_127_3702)">
    ...
    <div className="relative shrink-0 size-[16px]" data-name="time / calendar outlined">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="time / calendar outlined">
          <mask height="16" id="mask0_127_3662" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="16" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="16" id="Bounding box" width="16" />
          </mask>
          <g mask="url(#mask0_127_3662)">
    ...
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[20px] top-1/2" data-name="keyboard_arrow_down">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="keyboard_arrow_down">
          <mask height="20" id="mask0_127_3731" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_127_3731)">
...
function Text7() {
  return (
    <div className="content-stretch flex items-center justify-center px-[4px] relative shrink-0" data-name="Text">
      <div className="flex flex-col font-['Strawberry_Sans_Text:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#121110] text-[14px] text-center whitespace-nowrap">
...
function Button() {
  return (
    <div className="bg-[#f7f5f3] content-stretch flex items-center justify-center px-[12px] py-[8px] relative rounded-[8px] shrink-0" data-name="Button">
      <Text7 />
    </div>
  );
}
...
function Text8() {
  return (
    <div className="content-stretch flex items-center justify-center px-[4px] relative shrink-0" data-name="Text">
      <div className="flex flex-col font-['Strawberry_Sans_Text:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#121110] text-[14px] text-center whitespace-nowrap">
        <p className="leading-[20px]">Not helpful</p>
      </div>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="bg-[#f7f5f3] content-stretch flex items-center justify-center p-[4px] relative rounded-[8px] shrink-0" data-name="Button">
      <Text8 />
    </div>
  );
}
...
function Frame105() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <p className="font-['Strawberry_Sans_Text:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-black">Why?</p>
      <Button />
      <Button1 />
      <Button2 />
      <Button3 />
...
function KeyboardArrowUp() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[20px] top-1/2" data-name="keyboard_arrow_up">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="keyboard_arrow_up">
          <mask height="20" id="mask0_127_3710" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_127_3710)">
            <path d={svgPaths.p28e8f300} fill="var(--fill-0, #5A0032)" id="keyboard_arrow_up_2" />
          </g>
        </g>
      </svg>
    </div>
...
function ArrowsChevronUp() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="arrows / chevron up">
      <KeyboardArrowUp />
    </div>
  );
}
...
function Text11() {
  return (
    <div className="content-stretch flex items-center justify-center px-[4px] relative shrink-0" data-name="Text">
      <div className="flex flex-col font-['Strawberry_Sans_Text:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#5a0032] text-[14px] text-center whitespace-nowrap">
        <p className="leading-[normal]">Guest briefing</p>
      </div>
    </div>
  );
}
...
function Content7() {
  return (
    <div className="content-stretch flex h-[24px] items-center justify-center opacity-0 relative shrink-0" data-name="Content">
      <IconLeft3 />
      <Text11 />
    </div>
  );
...
function BriefingCard() {
  return (
    <div className="absolute bg-white h-[196px] left-[848px] rounded-[8px] top-[94px] w-[632px]" data-name="Briefing Card">
      <div className="content-stretch flex flex-col gap-[8px] items-end overflow-clip px-[16px] py-[8px] relative rounded-[inherit] size-full">
        <Frame104 />
        <ul className="block font-['Strawberry_Sans_Text:Regular',sans-serif] leading-[0] list-disc not-italic relative shrink-0 text-[14px] text-black whitespace-nowrap whitespace-pre-wrap">
          <li className="mb-0 ms-[21px]">
            <span className="leading-[20px]">{`The hotel has been informed about a late check-in for the guest's arrival. `}</span>
          </li>
          <li className="mb-0 ms-[21px]">
            <span className="leading-[20px]">{`This is their first time staying with us, and they do not have any previous booking history. `}</span>
          </li>
          <li className="ms-[21px]">
            <span className="leading-[20px]">
              {`Additionally, it's worth noting that this guest has several positive aspects that make them a `}
              <br aria-hidden="true" />
              valued addition to our hotel community.
            </span>
          </li>
        </ul>
...
function MenuIcons1() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="menu icons">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="menu icons">
          <mask height="24" id="mask0_127_3763" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_127_3763)">
...
function MenuIcons2() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="menu icons">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="menu icons">
          <mask height="24" id="mask0_127_3642" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_127_3642)">
...
function MenuIcons3() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="menu icons">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="menu icons">
          <mask height="24" id="mask0_127_3742" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_127_3742)">
...
function MenuIcons4() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="menu icons">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="menu icons">
          <mask height="24" id="mask0_127_3666" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_127_3666)">
...
function MenuIcons5() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="menu icons">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="settings">
          <mask height="24" id="mask0_127_3674" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_127_3674)">
...
function MenuIcons6() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="menu icons">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="menu icons">
          <mask height="24" id="mask0_127_3628" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box" width="24" />
          </mask>
          <g mask="url(#mask0_127_3628)">
            <g id="lightbulb_circle">
              <mask height="24" id="mask1_127_3628" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="24" x="0" y="0">
                <rect fill="var(--fill-0, #D9D9D9)" height="24" id="Bounding box_2" width="24" />
              </mask>
              <g mask="url(#mask1_127_3628)" />
            </g>
...
export default function AnsweredFeedback() {
  return (
    <div className="bg-[#f7f5f3] relative size-full" data-name="Answered feedback">
      <Header />
      <Frame78 />
      <BackButton />
      <Frame76 />
